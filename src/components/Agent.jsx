...
function Agent({ agent }) {
  return (
    <div className="relative mx-auto w-fit">
      ...
      />
      <h3 className="hover-text absolute bottom-0 left-1/2 z-10 w-[110px] -translate-x-1/2 -translate-y-1/2 text-center text-2xl uppercase text-white transition-transform duration-300 before:absolute before:left-1/2 before:top-1/2 before:z-[-1] before:w-full before:-translate-x-1/2 before:-translate-y-1/2 before:border-[0.4em] before:border-y-[0.6em] before:border-solid before:border-primary-red before:border-l-transparent before:border-r-transparent">
        {agent.displayName}
      </h3>
    </div>
  );
