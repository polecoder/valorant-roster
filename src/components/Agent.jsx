...
function Agent({ agent }) {
  return (
    ...
    >
      <div className="hover-area relative flex h-[200px] w-[135px] items-start justify-center overflow-hidden bg-primary-blue xs:h-[275px] xs:w-[186px]">
        <div className="relative">
          ...
          <img
            ...
            className="hover-image w-[250px] max-w-fit scale-[115%] transition-transform duration-300 xs:w-[350px]"
          />
        </div>
        <h3 className="absolute bottom-0 left-0 z-[1] w-full border-t border-light bg-primary-blue text-center text-xl uppercase text-light xs:py-[2px] xs:text-3xl">
          {agent.displayName}
        </h3>
      </div>
    </Link>
