function AgentDetailsHero({ agent }) {
  ...
  return (
    <section className="relative mx-auto flex max-w-[500px] items-center overflow-hidden px-4 py-8 xs:h-[350px] xs:px-8 md:h-[400px] md:max-w-[1000px] lg:px-12">
      ...
      <div
        className="agent_bg-effect absolute left-3/4 top-1/2 h-[250px] w-[200px] -translate-x-1/2 -translate-y-1/2 xs:h-[325px] xs:w-[250px] md:top-2/3 md:h-[500px] md:w-[350px] lg:top-3/4 lg:h-[600px] lg:w-[450px]"
        style={agentBackgroundStyle}
      ></div>
      <img
        className="absolute left-3/4 top-1/2 w-[300px] -translate-x-1/2 -translate-y-1/2 xs:w-[350px] md:top-2/3 md:w-[650px] lg:top-3/4 lg:w-[750px]"
